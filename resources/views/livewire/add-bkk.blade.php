    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th scope="col" class="font-weight-bold text-darker">Unit</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="font-weight-bold text-darker">{{strtolower($item->unit->name)}}</td>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="font-weight-bold text-darker">{{$data['unit']['name']}}</td>
