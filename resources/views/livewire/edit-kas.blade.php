<div>
    ...
    <div class="form-group">
        ...
        <input wire:model.defer="jumlah" type="text" class="form-control" placeholder="Nominal Kas Keluar" id="jumlah" name="jumlah" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <select wire:model="selectedUnit" class="form-control">
            ...
            <option value="{{$unit->id}}">{{$unit->name}}</option selected>
            @endif
